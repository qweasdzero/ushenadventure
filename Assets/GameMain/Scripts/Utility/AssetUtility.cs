...
namespace StarForce
{
    public static class AssetUtility
    {
        ...
        {
            return Utility.Text.Format("Assets/GameMain/Configs/{0}.{1}", assetName,
        ...
        public static string GetDictionaryAsset(string assetName, LoadType loadType)
        {
            return Utility.Text.Format("Assets/GameMain/Localization/{0}/Dictionaries/{1}.{2}",
                GameEntry.Localization.Language.ToString(), assetName, loadType == LoadType.Text ? "xml" : "bytes");
        }
        ...
        public static string GetRoleSoundAsset(string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Sounds/RoleSound/{0}.wav", assetName);
        }
